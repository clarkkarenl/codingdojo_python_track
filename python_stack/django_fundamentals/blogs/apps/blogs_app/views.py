...
# /new - display "placeholder to display a new form to create 
# a new blog" via HttpResponse. Have this be handled by a 
# method named 'new'.
def new(request):
...
# For example /15 should display a message 'placeholder to 
# display blog 15'.  Have this be handled by a method named 'show'.
...
# /{{number}}/delete - Have this be handled by a method named 
